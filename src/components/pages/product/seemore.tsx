...
import { ProductWithMedia } from "@/lib/types";
import Link from "next/link";

async function getProductData(companyId: string): Promise<{ products: ProductWithMedia[] }> {
...
async function SeeMore({ companyId }: { companyId: string }) {
