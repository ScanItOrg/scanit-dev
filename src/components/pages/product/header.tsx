    ...
    <React.Fragment>
      ...
      <div>
        <div className="flex w-full justify-center items-center gap-4">
          <h3 className="font-semibold text-2xl tracking-widest">{product?.name} </h3>
          <p className="tracking-widest font-thin text-lg">{product?.model_no}</p>
        </div>
        <p className="text-xs font-light tracking-widest text-gray-500">{product?.category}</p>
      </div>
    </React.Fragment>
  )
}
